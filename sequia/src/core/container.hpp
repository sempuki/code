...
namespace sequia
{
    namespace core
    {
        ...
        {
            return fixed_vector<T> {N, T(), typename fixed_vector<T>::allocator_type {N}};
        }
        ...
        {
            // TODO: std::map not fully c++11'ed
            return fixed_map<K,V,Compare> 
                {Compare(), typename fixed_map<K,V,Compare>::allocator_type {N}};
        }
    }
}
